...
- (id)_objectForKey:(NSString *)key
{
    ...
    NSString * base64EncodeStr = [TRCThreeDES decryptString:encrypted];
    //NSLog(@"Base64 decrypted result: %@", base64EncodeStr);
    
    NSData *base64Decoded = [TRCBase64 decodeString:base64EncodeStr];
...
- (NSString *)_encryptObject:(id)object
{
    ...
    NSString *base64EncodeStr = [TRCBase64 stringByEncodingData:archivedData];
    NSString *encrypted = [TRCThreeDES encryptString:base64EncodeStr];
    return encrypted;
}
