...
@implementation UIView (TRCViewUtils)
...
#pragma mark 根据矩形轮廓的位置，计算目标尺寸对应的矩形轮廓中中心位置
+ (CGRect)getCenterRectWithProfileRect:(CGRect)profileRect targetSize:(CGSize)targetSize {
    
    CGRect centerRect = CGRectMake((CGRectGetWidth(profileRect) - targetSize.width) / 2, (CGRectGetHeight(profileRect) - targetSize.height) / 2, targetSize.width, targetSize.height);
