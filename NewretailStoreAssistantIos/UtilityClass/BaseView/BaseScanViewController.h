...
@interface BaseScanViewController : BaseViewController<UIImagePickerControllerDelegate,UINavigationControllerDelegate>
...
/**
 @brief  扫码底部提示
 */
@property (strong,nonatomic) UILabel *toastLable;
/**
 @brief  开启灯光按钮
 */
@property (strong,nonatomic) LightBT *lapBt;
